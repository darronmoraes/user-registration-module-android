...
import com.example.sts_registration_test.ticketbooking.BusStops;
...
public class TicketFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View rootView, @Nullable Bundle savedInstanceState) {
        ...
        tvId = rootView.findViewById(R.id.id);
        tvLat = rootView.findViewById(R.id.lat);
        tvLong = rootView.findViewById(R.id.lng);
